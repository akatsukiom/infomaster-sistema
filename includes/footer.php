  ...
  <div class="container">
    <div class="footer-content">
      ...
      <div class="footer-section about">
        ...
        <div class="contact">
          <p><i class="fas fa-envelope"></i> info@infomaster.com.mx</p>
      ...
      <div class="footer-section links">
        ...
        <ul>
          ...
          <li><a href="<?= URL_SITIO ?>terminos">Términos y condiciones</a></li>
          <li><a href="<?= URL_SITIO ?>privacidad">Política de privacidad</a></li>
        </ul>
      </div>
      ...
      <div class="footer-section support">
        ...
        <ul>
          ...
          <li><a href="<?= URL_SITIO ?>soporte">Soporte técnico</a></li>
          <li><a href="<?= URL_SITIO ?>metodos-pago">Métodos de pago</a></li>
        </ul>
