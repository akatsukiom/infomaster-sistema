...
<div class="container">
    <div class="como-funciona-container">
        ...
        <div class="proceso-steps">
            <div class="proceso-step">
                ...
                <div class="paso-info">
                    ...
                    <div class="paso-imagen">
                        <img src="img/paso-1.jpg" alt="Crear cuenta">
                    </div>
                    <?php if(!estaLogueado()): ?>
                        <a href="modulos/usuarios/registro.php" class="btn">Crear cuenta ahora</a>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="proceso-step">
                ...
                <div class="paso-info">
                    ...
                    <div class="paso-imagen">
                        <img src="img/paso-2.jpg" alt="Recargar wallet">
                    </div>
                    <?php if(estaLogueado()): ?>
                        <a href="modulos/wallet/recargar.php" class="btn">Recargar wallet</a>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="proceso-step">
                ...
                <div class="paso-info">
                    ...
                    <div class="paso-imagen">
                        <img src="img/paso-3.jpg" alt="Seleccionar producto">
                    </div>
            ...
            <div class="proceso-step">
                ...
                <div class="paso-info">
                    ...
                    <div class="paso-imagen">
                        <img src="img/paso-4.jpg" alt="Recibir acceso">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="cta-section">
            ...
            <?php if(!estaLogueado()): ?>
                <a href="modulos/usuarios/registro.php" class="btn btn-large">Crear cuenta gratis</a>
            <?php else: ?>
